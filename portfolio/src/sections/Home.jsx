...
export default function Home() {
  const socials = [
    ...
    },
    {
      Icon: FaLinkedinIn,
      label: "LinkedinIn",
      href: "https://www.linkedin.com/in/kartik-kathrotiya-a5722a314/",
    },
    { Icon: FaGithub, label: "Github", href: "https://github.com/kartik0542" },
  ];
  const glowVarients = {
    // glow for icons or ye hover effect ke liye hai icon ke
    ...
    const timeout = setTimeout(
      () => {
        ...
        if (!deleting && subIndex < currentRole.length)
          // jo aapne delete nathi karta to eno mean k e word type thai ryo 6,tab check kar rahe ki jo word type ho raha hai uski index currentRole.length(full word) se chhoti hai
          ...
          setSubIndex((v) => v - 1); // ab sub index 0 se bada ho to 1 - 1 word delete
        else if (deleting && subIndex === 0) {
          // bad me sab 0 huve tab
        ...
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          ...
          <div className="w-full pl-2 lg:pr-24 mx-auto max-w-48rem">
            ...
            >
              ...
              <a
                href="/Kartik_Kathrotiya_Resume.pdf"
                target="_blank"
